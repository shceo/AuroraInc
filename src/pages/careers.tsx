      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="relative max-w-3xl">
          <input
            ...
            className="w-full p-4 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-400 border border-gray-200"
          />
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="bg-white border text-black px-4 py-2 rounded-full hover:shadow transition">
                Разработка
              </button>
              <button className="bg-white border text-black px-4 py-2 rounded-full hover:shadow transition">
          ...
          {/* <div className="bg-white rounded shadow p-4 w-full md:w-1/3">
            <h2 className="font-semibold mt-2 mb-2 text-black">
