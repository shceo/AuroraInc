...
export default function About() {
  return (
    <div className="min-h-screen bg-customDark py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <motion.div 
            className="lg:col-span-2 bg-gray rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
