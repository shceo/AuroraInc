      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-4xl font-bold text-blue-600">Aurora Weather</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-xl text-gray-600 mb-8">
              Advanced weather forecasting powered by AI, providing accurate predictions and detailed weather insights.
            </p>

            <h2 className="text-2xl font-semibold text-blue-600 mb-4">Features</h2>
            <ul className="space-y-2 text-gray-600">
              <li>AI-powered weather predictions</li>
